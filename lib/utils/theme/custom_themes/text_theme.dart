...
class SrkayTextTheme {
  SrkayTextTheme._();
    ...
    static TextTheme lightTextTheme = TextTheme(
      ...
      bodySmall: const TextStyle().copyWith(fontSize: 13.0, fontWeight: FontWeight.bold, color: Colors.black.withOpacity(0.5)),
      ...
      // labelSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w600, color: Colors.black),
    );
    ...
    static TextTheme darkTextTheme = TextTheme(
      ...
      // labelSmall: const TextStyle().copyWith(fontSize: 18.0, fontWeight: FontWeight.w600, color: Colors.white),
    );
